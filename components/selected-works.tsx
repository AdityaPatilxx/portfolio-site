...
const projects = [
  {
    ...
    color: "linear-gradient(135deg, var(--card) 0%, var(--secondary) 100%)",
    pattern: "radial-gradient(circle at 50% 50%, var(--primary) 1px, transparent 1px)",
  },
  {
    title: "CloudForge",
    ...
    color: "linear-gradient(135deg, var(--background) 0%, var(--card) 100%)",
    pattern: "linear-gradient(45deg, var(--border) 25%, transparent 25%, transparent 50%, var(--border) 50%, var(--border) 75%, transparent 75%, transparent)",
  },
  {
    title: "Artisan",
    ...
    color: "linear-gradient(135deg, var(--secondary) 0%, var(--background) 100%)",
    pattern: "repeating-linear-gradient(45deg, transparent, transparent 10px, var(--border) 10px, var(--border) 20px)",
  },
  {
    title: "Synapse",
    ...
    color: "linear-gradient(135deg, var(--card) 0%, var(--background) 100%)",
    pattern: "radial-gradient(ellipse at center, var(--primary) 0%, transparent 70%)",
  },
]
